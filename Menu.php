            ...
            <div class="container-fluid">  <!--inicio del div contenedor principal-->
                ...
                <div class= "collapse navbar-collapse" id="navbarSupportedContent"> <!--Contenedor para generar efecto  menu-->
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0"> 
                        <li class="nav-item"><a class="nav-link active" href="index.php">Inicio</a></h1>
                        <li class="nav-item"><a class="nav-link active" href="registro_empleado.php">Registro de empleado</a></li>
                        <li class="nav-item"><a class="nav-link active" href="registro_producto.php">Registro de Producto</a></li>
